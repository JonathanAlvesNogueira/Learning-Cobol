IDENTIFICATION DIVISION.
      ...
      *AUTHOR. Jonathan Alves Nogueira.
      ******************************
...
R0-PROCEDURE.
       ...
       IF ST-ERRO NOT = "00"
        ...
        IF ST-ERRO = "30"
          ...
          PERFORM R0A-DISPLAY-MESSAGE THRU R0A-DISPLAY-MESSAGE-END
          CLOSE ARQCLI
          GO TO R0-INICIO
        ELSE
          IF ST-ERRO = "95"
